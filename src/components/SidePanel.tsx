            ...
            {active.map(task => {
              ...
              return (
                <div key={task.id} style={{
                  ...
                  {task.description && (
                    <div style={{ color: '#aaaaaa', fontSize: 6, lineHeight: 1.8, marginTop: 4, wordBreak: 'break-word', fontFamily: 'monospace' }}>
            ...
            {completed.map((task, i) => {
              ...
              return (
                <div key={task.id} style={{
                  ...
                  {task.description && (
                    <div style={{ color: '#777777', fontSize: 5, lineHeight: 1.8, marginBottom: 4, fontFamily: 'monospace', wordBreak: 'break-word' }}>
